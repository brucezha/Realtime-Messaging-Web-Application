! function (e) {
    ...
    */
    ...
    var o = n(3),
        i = n(11),
        a = n(6),
        s = (n(1), "function" == typeof Proxy, ["dispatchConfig", "_targetInst", "nativeEvent", "isDefaultPrevented", "isPropagationStopped", "_dispatchListeners", "_dispatchInstances"]),
        u = {
            type: null,
            target: null,
    ...
    var i = n(3),
        a = n(10),
        s = (n(1), n(76), Object.prototype.hasOwnProperty),
        u = n(74),
        l = {
            key: !0,
            ref: !0,
    ...
    var o = n(18),
        ...
        s = n(176),
        u = r(s);
    (0, a.render)(i.default.createElement(u.default, null), document.getElementById("app"))
}, function (e, t) {
    function n(e, t) {
    ...
    function u(e, t) {
        ...
        if (t.singleton) {
            var u = g++;
            n = v || (v = a(t)), r = l.bind(null, n, u, !1), o = l.bind(null, n, u, !0)
    ...
    t = e.exports = n(82)(), t.push([e.i, "*{margin:0;padding:0;border:none;font-family:Open Sans,Helvetica Neue,Helvetica,Arial,sans-serif;box-sizing:border-box}body{background:url(" + n(84) + ") 50%;background-size:cover;background-attachment:fixed;font-size:15px}@media (max-width:768px){body{background:url(" + n(83) + ') 50%;background-size:cover;background-attachment:fixed}}.login-box{position:absolute;display:block;top:50%;left:50%;width:100%;text-align:center;height:200px;width:300px;margin-left:-150px;margin-top:-100px;background:hsla(0,0%,100%,.8);border-radius:10px;padding:20px;color:#333}.login-box input{height:30px;font-size:12px;border:none;border-radius:2px;box-shadow:0 2px 2px 0 rgba(0,0,0,.16),0 0 0 1px rgba(0,0,0,.08);transition:box-shadow .2s cubic-bezier(.4,0,.2,1);margin-top:30px;padding:10px;outline:none}.login-box input:focus,.login-box input:hover{box-shadow:0 3px 8px 0 rgba(0,0,0,.2),0 0 0 1px rgba(0,0,0,.08)}.login-box button{border-radius:2px;color:#757575;cursor:default;font-family:arial,sans-serif;font-size:13px;font-weight:700;margin:11px 4px;min-width:54px;padding:0 16px;text-align:center;height:27px;line-height:18px}.login-box button:hover{background-image:-webkit-gradient(linear,left top,left bottom,from(#f8f8f8),to(#f1f1f1));background-image:-webkit-linear-gradient(top,#f8f8f8,#f1f1f1);-webkit-box-shadow:0 1px 1px rgba(0,0,0,.1);background-color:#f8f8f8;background-image:linear-gradient(top,#f8f8f8,#f1f1f1);background-image:-o-linear-gradient(top,#f8f8f8,#f1f1f1);border:1px solid #c6c6c6;box-shadow:0 1px 1px rgba(0,0,0,.1);color:#222}.chat-room{color:#fff}.chat-room .welcome{width:100%;color:rgba(0,0,0,.870588);background:#fff;padding:10px 0;position:fixed;top:0;line-height:24px}.chat-room .welcome:after{content:"";display:table;clear:both}.chat-room .welcome .room-name{float:left;margin-left:5%}.room-status{margin-top:50px;text-align:center;font-size:13px}.messages{padding:5px 10px 60px;font-size:15px}.messages .one-message.system-message{font-size:13px;color:#e0e0e0;flex-direction:row;justify-content:center;align-items:baseline}.messages .one-message{padding-bottom:10px;display:flex;flex-direction:column;justify-content:flex-start;align-items:flex-start}.messages .one-message p{margin-bottom:5px}.messages .one-message .time{color:#e0e0e0}.messages .one-message .message-content{color:rgba(0,0,0,.870588);padding:5px 10px;margin:0;box-shadow:3px 3px 10px rgba(0,0,0,.117647);word-break:break-all;border-radius:10px;display:inline-block;background-color:#f1f1f1}.messages .one-message.me{flex-direction:column;justify-content:flex-start;align-items:flex-end}.messages .one-message.me .message-content{background:#a2e563}.input-box{position:fixed;bottom:0;width:100%;background:#fff;padding:10px 0;font-size:14px}.input-box:after{content:"";display:table;clear:both}.input-box .input input{margin-left:5%;width:70%;outline:none;float:left;color:rgba(0,0,0,.870588);font-size:100%;line-height:24px;border-bottom-width:2px;-webkit-transition:border-color .2s ease;background:0;border:0;border-bottom:2px solid #e0e0e0}.button{float:right;width:20%}.button button{background-color:#fff;transition:all .45s cubic-bezier(.23,1,.32,1) 0ms;box-sizing:border-box;font-family:Roboto,sans-serif;-webkit-tap-highlight-color:transparent;box-shadow:0 1px 6px rgba(0,0,0,.117647),0 1px 4px rgba(0,0,0,.117647);border-radius:2px;display:inline-block;padding:3px 15px;font-size:13px;letter-spacing:0;font-weight:500;margin:0;color:rgba(0,0,0,.870588);min-width:65px;outline:0}', ""])
}, function (e, t) {
    e.exports = function () {
        var e = [];
    ...
    e.exports = n.p + "92af999b8a85d915ad5e26d879fd0a87.jpg"
}, function (e, t, n) {
    e.exports = n.p + "1d4311341b7fc218d89c3a9eedc5d5aa.jpg"
}, function (e, t, n) {
    "use strict";
    ...
    function l(e, t, n, r) {
        var o, l;
        if (_ ? o = i(e) : N ? s(e, n) && (o = T.compositionEnd) : a(e, n) && (o = T.compositionStart), !o) return null;
        x && (N || o !== T.compositionStart ? o === T.compositionEnd && N && (l = N.getData()) : N = m.getPooled(r));
    ...
    function o(e) {
        var t = x.getPooled(P.change, M, e, w(e));
    ...
    function c(e, t) {
        N = e, M = t, S = e.value, O = Object.getOwnPropertyDescriptor(e.constructor.prototype, "value"), Object.defineProperty(N, "value", R), N.attachEvent ? N.attachEvent("onpropertychange", d) : N.addEventListener("propertychange", d, !1)
    }

    function p() {
        N && (delete N.value, N.detachEvent ? N.detachEvent("onpropertychange", d) : N.removeEventListener("propertychange", d, !1), N = null, M = null, S = null, O = null)
    }
    ...
    var R = {
        ...
        D = {
            ...
            extractEvents: function (e, t, n, o) {
                ...
                if (r(s) ? I ? i = u : a = l : T(s) ? A ? i = f : (i = m, a = h) : v(s) && (i = g), i) {
                    var c = i(e, t);
                    if (c) {
    ...
    function o(e, t) {
        t && (X[e._tag] && (null != t.children || null != t.dangerouslySetInnerHTML ? m("137", e._tag, e._currentElement._owner ? " Check the render method of " + e._currentElement._owner.getName() + "." : "") : void 0), null != t.dangerouslySetInnerHTML && (null != t.children ? m("60") : void 0, "object" == typeof t.dangerouslySetInnerHTML && H in t.dangerouslySetInnerHTML ? void 0 : m("61")), null != t.style && "object" != typeof t.style ? m("62", r(e)) : void 0)
    }
    ...
    h.displayName = "ReactDOMComponent", h.Mixin = {
        mountComponent: function (e, t, n, r) {
            ...
            if (e.useCreateElement) {
                ...
                d = !x && z[this._tag] ? C + "/>" : C + ">" + x + "</" + this._currentElement.type + ">"
            }
            switch (this._tag) {
                case "input":
    ...
    var s = function () {
        ...
        c = function (e) {
            function t(e) {
                ...
                return n.state = {
                    socket: n.props.socket,
                    message: "",
                    myId: n.props.myId,
                    myName: n.props.myName
                }, n
            }
            return a(t, e), s(t, [{
                key: "handleChange",
                ...
                key: "handleKeyPress",
                value: function (e) {
                    return "Enter" == e.key && this.sendMessage(), !1
                }
            }, {
                key: "sendMessage",
                value: function (e) {
                    ...
                    if (t) {
                        ...
                        n.emit("message", r), this.setState({
                            message: ""
                        })
                    }
                    return !1
    ...
    var s = function () {
        ...
        v = function (e) {
            ...
            return a(t, e), s(t, [{
                key: "handleUsers",
                value: function () {
                    var e = this.state.onlineUsers,
                        t = "",
                        n = "";
                    for (var r in e) e.hasOwnProperty(r) && (t += n + e[r], n = "、");
                    this.setState({
                        userhtml: t
                    })
                }
                ...
                key: "generateMsgId",
                value: function () {
                    return (new Date).getTime() + "" + Math.floor(899 * Math.random() + 100)
                }
            }, {
                key: "updateSysMsg",
                value: function (e, t) {
                ...
                value: function () {
                    ...
                    return e = 0 == e ? "00" : e, t = t < 10 ? "0" + t : t, e + ":" + t
                }
            }, {
                key: "handleLogout",
                value: function () {
                ...
                value: function () {
                    var e = this,
                        t = this.state.socket;
                    t.on("login", function (t) {
                        e.updateSysMsg(t, "login")
                    }), t.on("logout", function (t) {
                        e.updateSysMsg(t, "logout")
                ...
                value: function () {
                    return l.default.createElement("div", {
                        ...
                        className: "room-name"
                    }, "鱼头的聊天室 | ", this.state.myName), l.default.createElement("div", {
                        className: "button"
                    }, l.default.createElement("button", {
                        onClick: this.handleLogout
                    }, "登出"))), l.default.createElement(p.default, {
    ...
    var s = function () {
        ...
        d = function (e) {
            ...
            return a(t, e), s(t, [{
                ...
                value: function () {
                    var e = p.default.findDOMNode(this.refs.messages);
                    window.scrollTo(0, e.clientHeight + 50)
                }
            }, {
                key: "render",
                value: function () {
                    var e = this.props.myId,
    ...
    var f = function (e) {
        ...
        return a(t, e), s(t, [{
            key: "render",
            value: function () {
                return "system" == this.props.msgType ? l.default.createElement("div", {
                    className: "one-message system-message"
                }, this.props.msgUser, " ", "login" == this.props.action ? "进入了聊天室" : "离开了聊天室", " ", l.default.createElement("span", {
                    className: "time"
                }, " ", this.props.time)) : l.default.createElement("div", {
                    className: this.props.isMe ? "me one-message" : "other one-message"
                }, l.default.createElement("p", {
                    className: "time"
                }, l.default.createElement("span", null, this.props.msgUser), " ", this.props.time), l.default.createElement("div", {
        ...
        c = function (e) {
            ...
            return a(t, e), s(t, [{
                ...
                value: function () {
                    ...
                    }, "在线人数: ", this.props.onlineCount, ", 在线列表: ", this.props.userhtml)
                }
            }]), t
        }(u.Component);
    t.default = c
    ...
    var d = function (e) {
        ...
        return a(t, e), s(t, [{
            key: "generateUid",
            value: function () {
                return (new Date).getTime() + "" + Math.floor(9 * Math.random() + 1)
            }
        }, {
            key: "handleChange",
            value: function (e) {
            ...
            key: "handleKeyPress",
            value: function (e) {
                return "Enter" == e.key && this.handleLogin(), !1
            }
        }, {
            key: "handleLogin",
            value: function () {
            ...
            value: function () {
                var e = void 0;
                return e = this.state.uid ? l.default.createElement(p.default, {
                    uid: this.state.uid,
                    username: this.state.username,
                    socket: this.state.socket
                }) : l.default.createElement("div", {
                    className: "login-box"
                }, l.default.createElement("h2", null, "登 陆"), l.default.createElement("div", {
                    className: "input"
                }, l.default.createElement("input", {
                    type: "text",
                    placeholder: "请输入用户名",
                    ...
                    type: "button",
                    onClick: this.handleClick.bind(this)
                }, "提交"))), l.default.createElement("div", null, e)
            }
        }]), t
    }(u.Component);
    t.default = d
